...
## Principio Meta/Instagram

Tratar o criativo como o principal sinal de distribuicao.

A peca visual, seja imagem, carrossel ou video, precisa ser compreensivel e interessante por si so, porque o algoritmo da Meta tende a interpretar imagem/video e considerar esse conteudo visual mais relevante do que legenda ou hashtags isoladas.

Legenda e hashtags continuam importantes, mas sao apoio. Nao podem ser a unica fonte de contexto.

## Papel Do Conteudo

Criativos devem cumprir uma ou mais funcoes:

- chamar atencao do dono/gestor de negocio local;
- ensinar algo util sobre retencao, recompra, base de clientes, margem, recorrencia ou campanhas;
- gerar salvamentos, compartilhamentos, comentarios ou DMs qualificadas;
...
O supervisor e responsavel pela curadoria final de artes, videos, stories, carrosseis, roteiros e copies antes de publicacao/agendamento.

Responsabilidades:

- revisar conteudo antes de publicar/agendar;
- apontar ajustes pontuais que aumentem conversao;
- garantir que a peca visual se sustente sem depender da legenda;
...
- checar portugues brasileiro;
- garantir que legenda/hashtags nao estejam dentro da arte;
- garantir uso correto da marca oficial.

## Checklist De Conversao E Algoritmo

Antes de liberar, responder:

- O hook prende atencao nos 2 primeiros segundos ou primeira dobra?
- A imagem/video/carrossel comunica a ideia principal sem depender da legenda?
- O ICP entende que o conteudo e para ele?
- A dor e concreta ou esta generica demais?
...
## Conteudo Organico E Monetizacao Indireta

Nem todo conteudo precisa vender plano imediatamente. Alguns criativos devem construir publico organico e ativos monetizaveis.

Linhas permitidas:

- ebooks gratuitos para captar lead qualificado;
- ebooks/infoprodutos low ticket para validar dor e gerar caixa;
- checklists e guias para donos de loja;
...
Cada peca deve sair com um dos status:
...
- Valor entregue:
- CTA:
- Potencial de retencao organica:
- Possivel monetizacao indireta:
- Status:
- Melhorias pontuais:
- Risco identificado:
- Motivo da decisao:
...
- Producao e aprovacao devem ser separadas sempre que possivel.
- Quando a mesma pessoa/agente precisar produzir e revisar, executar revisao em segunda passada usando checklist objetivo.
