...
Funcao hibrida entre Produto, Marketing, Comercial e CS.

Pode atuar como:

- jornalista publicitario;
- redator estrategico;
- roteirista de videos;
- criador de PDFs/checklists/guias;
- criador de ofertas gratuitas ou low ticket.
...
- ofertas low ticket de escopo pequeno.
...
1. Produto/PO define dor, publico e mecanismo.
2. Redator cria PDF/roteiro/oferta.
3. Supervisao de Marketing e Criativos revisa conversao, clareza, visual e risco.
4. Comercial valida se ajuda diagnostico.
5. Growth distribui no canal adequado.
6. RevOps mede sinal gerado.
7. Produto registra novas dores e demandas recorrentes.

## Metricas

- downloads;
- comentarios qualificados;
- DMs pedindo diagnostico;
- cliques no link;
- leads mais educados;
- diagnosticos gerados;
- trials iniciados;
- objeccoes reduzidas;
- feedback de dores novas.
