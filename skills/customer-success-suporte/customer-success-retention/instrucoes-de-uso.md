...
Este arquivo orienta como preparar e operar a skill `customer-success-retention` em um negocio real. Ajuste nomes de sistemas, contas, politicas e limites antes de ativar automacoes.
