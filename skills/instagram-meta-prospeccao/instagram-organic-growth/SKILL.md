...
- Card escuro com texto grande + formas decorativas sem contexto real de loja.
- Peca que pareca primeira versao de instrucao ou wireframe colorido.
- Criativo feito apenas para preencher quantidade.
...
7. Entregar para aprovacao visual antes de qualquer Canva/agendamento.

## Regua minima de qualidade
...
- Tem dor economica real do varejo?
- Tem mecanismo claro de recompra/fidelidade/cashback/CRM?
- Tem texto curto, legivel e com acentuacao correta?
- Usa a logo oficial real, aplicada depois?
- Nao tem legenda longa nem hashtags dentro da imagem?
- Nao parece template, wireframe, card generico ou arte feita para preencher volume?

Se alguma resposta for NAO, refazer ou parar.
...
7. Gerar preview/folha de revisao so depois de passar na regua minima.
8. Nao agendar/publicar sem aprovacao explicita.

## Regra de parada

Se o pedido for por volume, mas o ambiente nao permitir gerar com qualidade premium, nao substituir por template programatico. Responder com o bloqueio e propor gerar uma rodada menor no padrao correto.

Quantidade nunca justifica regredir qualidade.
