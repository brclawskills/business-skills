...
Este arquivo orienta como preparar e operar a skill `instagram-response-monitoring` em um negocio real. Ajuste nomes de sistemas, contas, politicas e limites antes de ativar automacoes.
