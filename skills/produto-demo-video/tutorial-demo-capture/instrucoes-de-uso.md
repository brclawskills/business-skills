...
Este arquivo orienta como preparar e operar a skill `tutorial-demo-capture` em um negocio real. Ajuste nomes de sistemas, contas, politicas e limites antes de ativar automacoes.
